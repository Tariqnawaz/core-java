...
public class O004_InheritanceInnerClass {
...
/*----------------------2nd Example----------------------*/
/*An inner class can be extended by another class outside of it’s outer class. If you are extending static inner class (Static nested class), then it 
...
class AnotherClassOne112 extends OuterClass.InnerClassOne{
...
/*----------------------3rd Example----------------------*/
/*When an outer class is extended by it’s sub class, Member inner classes will not be inherited to sub class. To use inner class properties inside the 
 sub class of outer class, sub class must also have an inner class and that inner class must extend inner class of the outer class. For example,*/
class OuterClass211{
    int x;
...
/*----------------------4th Example----------------------*/
/*Inner class can extend it’s outer class. But, it does not serve any meaning. Because, even the private members of outer class are available inside 
...
class InnerClasses2{
    public static void main(String args[]){
        OuterClass512 outer = new OuterClass512();
        //You have to create OuterClass object to access non-static inner class
 
        OuterClass512.InnerClass inner = outer.new InnerClass();  //creating object to InnerClass
