...
public class ThreadPool_Queue_N_ConsumerTask_Coderevisited {
	
	private final BlockingQueue<Integer> queue;
    private static final Random rnd = new Random();
	
	public static void main(String[] args) {
		ThreadPool_Queue_N_ConsumerTask_Coderevisited t = new ThreadPool_Queue_N_ConsumerTask_Coderevisited();
	}
	
	public ThreadPool_Queue_N_ConsumerTask_Coderevisited()
    {
